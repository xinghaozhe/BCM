...
#ifndef __STM8_TIM3_H
#define __STM8_TIM3_H
...
/** TIM3 Time Base Init structure definition */
typedef struct
{
    u8 TIM3_Prescaler;
    u16 TIM3_Period;
    
} TIM3_TimeBaseInit_TypeDef;

/** TIM3 Output Compare Init structure definition */
typedef struct
{
    u8 TIM3_OCMode;
    u8 TIM3_OutputState;
...
/** TIM3 Input Capture Init structure definition */
typedef struct
{
    u8 TIM3_Channel;
    u8 TIM3_ICPolarity;
...
typedef enum
{
 ...
 TIM3_OUTPUTSTATE_ENABLE            =((u8)0x01)
...
typedef enum
{
  ...
  TIM3_ICPOLARITY_FALLING           =((u8)0x01)
