...
#ifndef __STM8_TIM1_H
#define __STM8_TIM1_H
...
typedef struct
{
  u8 TIM1_OCMode;
  u8 TIM1_OutputState;
  u8 TIM1_OutputNState;
  u16 TIM1_Pulse;
  u8 TIM1_OCPolarity;
  u8 TIM1_OCNPolarity;
  u8 TIM1_OCIdleState;
  u8 TIM1_OCNIdleState;
}
TIM1_OCInit_TypeDef;
...
/** TIM1 BDTR structure definition */
typedef struct
{
  u8 TIM1_OSSIState;
  u8 TIM1_LockLevel;
...
typedef enum
{
  ...
  TIM1_OUTPUTSTATE_ENABLE            = ((u8)0x01)
...
typedef enum
{
  ...
  TIM1_OUTPUTNSTATE_ENABLE  = (u8)0x01
...
#define IS_TIM1_CLEAR_FLAG_OK(FLAG) (((FLAG & (u16)0xE100) == 0x0000) && (FLAG != 0x0000))
...
void TIM1_ETRClockMode1Config(u8 TIM1_ExtTRGPrescaler, u8 TIM1_ExtTRGPolarity,u8 ExtTRGFilter);
void TIM1_ETRClockMode2Config(u8 TIM1_ExtTRGPrescaler, u8 TIM1_ExtTRGPolarity,u8 ExtTRGFilter);
void TIM1_ETRConfig(u8 TIM1_ExtTRGPrescaler, u8 TIM1_ExtTRGPolarity,u8 ExtTRGFilter);
void TIM1_TIxExternalClockConfig(u8 TIM1_TIxExternalCLKSource, u8 TIM1_ICPolarity, u8 ICFilter);
...
void TIM1_EncoderInterfaceConfig(u8 TIM1_EncoderMode, u8 TIM1_IC1Polarity,u8 TIM1_IC2Polarity);
...
void TIM1_OC1NPolarityConfig(u8 TIM1_OCPolarity);
void TIM1_OC2PolarityConfig(u8 TIM1_OCPolarity);
void TIM1_OC2NPolarityConfig(u8 TIM1_OCPolarity);
void TIM1_OC3PolarityConfig(u8 TIM1_OCPolarity);
void TIM1_OC3NPolarityConfig(u8 TIM1_OCPolarity);
