...
#ifndef __STM8_TIM2_H
#define __STM8_TIM2_H
...
/** TIM2 Time Base Init structure definition */
typedef struct
{
    u8 TIM2_Prescaler;
    u16 TIM2_Period;
    
} TIM2_TimeBaseInit_TypeDef;

/** TIM2 Output Compare Init structure definition */
typedef struct
{
    u8 TIM2_OCMode;
    u8 TIM2_OutputState;
...
/** TIM2 Input Capture Init structure definition */
typedef struct
{
    u8 TIM2_Channel;
    u8 TIM2_ICPolarity;
...
typedef enum
{
 ...
 TIM2_OUTPUTSTATE_ENABLE            =((u8)0x01)
...
typedef enum
{
  ...
  TIM2_ICPOLARITY_FALLING           =((u8)0x01)
