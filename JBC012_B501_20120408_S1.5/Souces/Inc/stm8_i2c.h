...
typedef enum {
  ...
  I2C_IT_EVT_ERR = (u8)0x03, /*!< Event + Error Interruptions */
  I2C_IT_BUF     = (u8)0x04, /*!< Buffer Interruption */
  I2C_IT_BUF_ERR = (u8)0x05, /*!< Buffer + Error Interruptions */
  I2C_IT_BUF_EVT = (u8)0x06, /*!< Buffer + Event Interruptions */
  I2C_IT_ALL     = (u8)0x07  /*!< Buffer + Event + Error Interruptions */
} I2C_IT_Typedef;
...
typedef enum {
  ...
  I2C_EVENT_MASTER_BYTE_TRANSMITTED       = (u16)0x1780, /*!< EV8: TXE=1 */
  I2C_EVENT_MASTER_BYTE_TRANSFER_FINISHED = (u16)0x1784, /*!< EV8-2: TXE=1, BTF=1 */
...
#define IS_I2C_DUTYCYCLE_OK(DUTY) (((DUTY) == I2C_DUTYCYCLE_2) || \
                                   ((DUTY) == I2C_DUTYCYCLE_16_9))
  
#define IS_I2C_ACK_OK(ACK) (((ACK) == I2C_ACK_NONE) || \
                            ((ACK) == I2C_ACK_CURR) || \
                            ((ACK) == I2C_ACK_NEXT))

#define IS_I2C_ADDMODE_OK(ADDMODE) (((ADDMODE) == I2C_ADDMODE_7BIT) || \
                                    ((ADDMODE) == I2C_ADDMODE_10BIT))

#define IS_I2C_INTERRUPT_OK(IT) (((IT) == I2C_IT_ERR) || \
                                 ((IT) == I2C_IT_EVT) || \
                                 ((IT) == I2C_IT_EVT_ERR) || \
                                 ((IT) == I2C_IT_BUF) || \
                                 ((IT) == I2C_IT_BUF_ERR) || \
...
#define IS_I2C_DIRECTION_OK(DIR) (((DIR) == I2C_DIRECTION_TX) || \
                                  ((DIR) == I2C_DIRECTION_RX))

#define IS_I2C_FLAG_OK(FLAG) (((FLAG) == I2C_FLAG_TXEMPTY) || \
...
/** I2C possible events */
#define IS_I2C_EVENT_OK(EVENT) (((EVENT) == I2C_EVENT_SLAVE_ADDRESS_MATCHED) || \
                                ...
                                ((EVENT) == I2C_EVENT_MASTER_BYTE_TRANSFER_FINISHED) || \
                                ((EVENT) == I2C_EVENT_MASTER_HEADER_ACKED))

/** I2C own address */
#define IS_I2C_OWN_ADDRESS_OK(ADDRESS) ((ADDRESS) <= (u16)0x03FF)

/* The address must be even */
#define IS_I2C_ADDRESS_OK(ADD) (((ADD) & (u8)0x01) == (u8)0x00)
                                
/** I2C Input clock frequency must be between 1MHz and 50MHz */
#define IS_I2C_INPUT_CLOCK_FREQ_OK(FREQ) (((FREQ) >= (u8)1) && ((FREQ) <= (u8)50))

/** I2C Output clock frequency must be between 1Hz and 400kHz */
#define IS_I2C_OUTPUT_CLOCK_FREQ_OK(FREQ) (((FREQ) >= (u8)1) && ((FREQ) <= I2C_MAX_FAST_FREQ))
